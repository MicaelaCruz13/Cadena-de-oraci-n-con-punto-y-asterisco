...
// Función para buscar el carácter en la cadena
...
int main() {
	...
	// Determinar cuál cadena es la mayor y cuál es la menor
	if (strlen(cadena1) >= strlen(cadena2) && strlen(cadena1) >= strlen(cadena3)) {
		printf("\nLa primera cadena \"%s\" es la más larga.\n", cadena1);
	} else if (strlen(cadena2) >= strlen(cadena1) && strlen(cadena2) >= strlen(cadena3)) {
		printf("\nLa segunda cadena \"%s\" es la más larga.\n", cadena2);
	} else {
		printf("\nLa tercera cadena \"%s\" es la más larga.\n", cadena3);
	}
	
	if (strlen(cadena1) <= strlen(cadena2) && strlen(cadena1) <= strlen(cadena3)) {
		printf("La primera cadena \"%s\" es la más corta.\n", cadena1);
	} else if (strlen(cadena2) <= strlen(cadena1) && strlen(cadena2) <= strlen(cadena3)) {
		printf("La segunda cadena \"%s\" es la más corta.\n", cadena2);
	} else {
		printf("La tercera cadena \"%s\" es la más corta.\n", cadena3);
	}
